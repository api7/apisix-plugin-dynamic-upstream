...
=== TEST 13: operation is `ip_in` or `IP_IN`
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 14: ip_in and IP_IN match passed
--- request
GET /server_port
--- more_headers
ip-key: 127.0.0.1
...
=== TEST 15: ip_in or IP_IN match failed( Missing real-ip )
--- request
GET /server_port
--- more_headers
ip-key: 127.0.0.1
...
=== TEST 16: ip_in or IP_IN match failed( real-ip error )
--- request
GET /server_port
--- more_headers
ip-key: 127.0.0.1
